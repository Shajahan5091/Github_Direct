...
validated_order_items AS (
    SELECT
        ...
        ROUND(order_items.quantity) AS quantity, -- auto corrected using semantic file
...
calculated_amounts AS (
    SELECT
        ...
        quantity,
        unit_price,
        (quantity * COALESCE(unit_price, 0)) AS extended_amount,
        0.00 AS discount_amount, -- auto corrected using semantic file
        inserted_at
